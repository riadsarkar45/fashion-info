...
const Banner = () => {
    return (
        <div className="h-[20rem] mt-7 bg-red-500">
                ...
                <div className="py-8 px-4 mx-auto  text-center lg:py-16 z-10">
                    ...
                    >
                        ...
                        <span className="text-sm font-medium">
                            We have realeased our new services see what's new
                        </span>
                        <svg
                    ...
                    <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                        <Typewriter
                            words={['A clothing swap is a ', 'sustainable fashion exchange, where', 'people trade clothes', 'to reduce waste and refresh their wardrobes.']}
                            loop={500}
                            cursor
                            cursorStyle='_'
                            typeSpeed={80}
                    ...
                    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
                        A clothing swap is a sustainable and community-oriented event where people exchange their gently-used clothing items.
                    </p>
